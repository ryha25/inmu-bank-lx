    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Card className="border-border bg-card p-4">
          ...
          <p className="mt-2 font-mono text-xl font-bold tabular-nums text-chart-5">
            {formatInmu(totalReceived)}
          </p>
        </Card>
        <Card className="border-border bg-card p-4">
          ...
          <p className="mt-2 font-mono text-xl font-bold tabular-nums text-destructive">
            {formatInmu(totalSent)}
          </p>
        </Card>
      </div>
    </div>
